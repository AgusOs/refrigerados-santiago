  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        ...
        <h4>Hoy somos una empresa mayorista de alimentos y bebidas consolidada, con una estructura de 13 sucursales distribuidas a lo largo de La Pampa, tecnología adaptada, logística propia y un equipo de trabajo excepcional con personas que comparten los mismos valores de siempre. <br />
